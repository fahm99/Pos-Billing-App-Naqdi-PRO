...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  Future<void> _onAddProduct(
    ...
    result.fold(
      ...
      (_) {
        emit(state.copyWith(
            status: ProductStatus.success, message: 'تمت إضافة المنتج بنجاح'));
        add(LoadProducts());
      },
    );
  }
  ...
  Future<void> _onUpdateProduct(
    ...
    result.fold(
      ...
      (_) {
        emit(state.copyWith(
            status: ProductStatus.success, message: 'تم تحديث المنتج بنجاح'));
        add(LoadProducts());
      },
    );
  }
  ...
  Future<void> _onDeleteProduct(
    ...
    result.fold(
      ...
      (_) {
        emit(state.copyWith(
            status: ProductStatus.success, message: 'تم حذف المنتج بنجاح'));
        add(LoadProducts());
      },
    );
  }
