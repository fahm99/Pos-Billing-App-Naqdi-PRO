...
/// التعديل: إضافة جميع الحقول المفقودة (costPrice, stock, minStock, unit, category, expiryDate)
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      final existingProduct =
          productState.products.where((p) => p.barcode == _barcodeCtrl.text).firstOrNull;

      if (existingProduct != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('منتج بالباركود "${_barcodeCtrl.text}" موجود مسبقاً!'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(hintText: 'مثال: أرز بسمتي'),
