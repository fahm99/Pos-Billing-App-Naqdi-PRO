...
/// AddProductPage - شاشة إضافة منتج جديد محسّنة
/// التعديل: إضافة جميع الحقول المفقودة (costPrice, stock, minStock, unit, category, expiryDate, imageUrl)
...
class _AddProductPageState extends State<AddProductPage> {
  ...
  void initState() {
    ...
    _unitCtrl = TextEditingController(text: 'قطعة');
    _categoryCtrl = TextEditingController(text: 'عام');
    _loadCurrencySymbol();
  }
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      final existingProduct = productState.products
          .where((p) => p.barcode == _barcodeCtrl.text)
          .firstOrNull;

      if (existingProduct != null) {
        NotificationHelper.show(context, 'منتج بالباركود "${_barcodeCtrl.text}" موجود مسبقاً!');
        return;
      }
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Center(
                    child: Text('اضغط لإضافة صورة المنتج (اختياري)',
                        style:
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(hintText: 'مثال: أرز بسمتي'),
                    textCapitalization: TextCapitalization.words,
                    validator: AppValidators.required('الرجاء إدخال الاسم'),
                  ),
                  const SizedBox(height: 24),

                  // سعر البيع والتكلفة في صف واحد
                  Row(
                    children: [
                      Expanded(
                        child: Column(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Autocomplete<String>(
                              ...
                              initialValue:
                                  TextEditingValue(text: _unitCtrl.text),
                              ...
                              fieldViewBuilder:
                                ...
                                return TextFormField(
                                  ...
                                  focusNode: focusNode,
                                  decoration:
                                      const InputDecoration(hintText: 'قطعة'),
                            ...
                            Autocomplete<String>(
                              ...
                              fieldViewBuilder:
                                ...
                                return TextFormField(
                                  ...
                                  focusNode: focusNode,
                                  decoration:
                                      const InputDecoration(hintText: 'عام'),
